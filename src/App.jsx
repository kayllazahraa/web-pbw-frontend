...
export default function App() {// src/App.jsx
import React from "react";
import {
    Routes,
    Route,
...
import AddPublicationPage from "./components/AddPublicationPage";
import EditPublicationPage from "./components/EditPublicationPage";
import PublicationDetailPage from "./components/PublicationDetailPage"; // <-- Impor komponen baru
import Footer from "./components/Footer";
import LoginPage from "./components/LoginPage";
        ...
        <div className="bg-slate-50 min-h-screen font-sans">
            ...
            <main className="container mx-auto px-4 py-8">
                <Routes>
                    ...
                    <Route path="/publications/:id" element={<ProtectedRoute><PublicationDetailPage /></ProtectedRoute>} /> {/* <-- Tambahkan rute ini */}
